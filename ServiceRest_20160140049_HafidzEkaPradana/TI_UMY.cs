...
namespace ServiceRest_20160140049_HafidzEkaPradana
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-8MKEQ456; Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=mentepermaib20");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=LAPTOP-8MKEQ456; Initial catalog=\"TI UMY\";Persist Security Info=True; User ID=sa; Password=mentepermaib20");
        ...
        public Mahasiswa GetMahasiswaByNIM(string nim)
        {
            ...
            Mahasiswa mhs = new Mahasiswa(); SqlConnection con = new SqlConnection("Data source=LAPTOP-8MKEQ456; Initial catalog=\"TI UMY\";Persist Security Info=True; User ID=sa; Password=mentepermaib20");
